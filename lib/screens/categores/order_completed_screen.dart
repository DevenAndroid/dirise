    ...
    return Scaffold(
      ...
      child: SingleChildScrollView(
        child: Column(crossAxisAlignment: CrossAxisAlignment.center,
          children: [
         Image(height: 100,image: AssetImage('assets/images/check.png')),
            Padding(
            ...
            const SizedBox(height: 30,),
            Text("you will recieve a confirmation email soon.\n Thank you for using DIRISE.",style: GoogleFonts.poppins(fontWeight: FontWeight.w500,fontSize: 15,height: 1.8),
