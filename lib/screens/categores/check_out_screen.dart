                          ...
                          children: [
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                decoration: InputDecoration.collapsed(
                                    hintText: "Enter Code",
                                    hintStyle: GoogleFonts.poppins(color: const Color(0xff949495),
                                        fontSize: 14
                                    ),
                                )
                              ),
                ...
                children: [
                          ...
                          children: [
                            ...
                            Text("KWD $couponApplied",
                                style: GoogleFonts.poppins(fontWeight: FontWeight.w400,
                                  ...
                                  decoration: TextDecoration.lineThrough,decorationColor: Colors.lightGreenAccent
                                )
                            ),
                          ],
                        ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("KWD ${cartController.cartModel.total.toString().convertToNum! - (couponApplied.convertToNum ?? 0)}",
                          style: GoogleFonts.poppins(fontWeight: FontWeight.w500, fontSize: 18)),
                    ],
                  ),
                  const SizedBox(
