    ...
    return Scaffold(
      ...
      appBar:AppBar(backgroundColor:  const Color(0xffEBF1F4).withOpacity(.7),surfaceTintColor: Colors.white, elevation: 0,leading: IconButton(
        ...
        title: Row(
          ...
          children: [
            Text("Order",style: GoogleFonts.poppins(color: Colors.black,fontWeight: FontWeight.w600,fontSize: 22),),
      ...
      body: Padding(
        ...
        child: Column(crossAxisAlignment:CrossAxisAlignment.start,children: [
          Text("MY Orders",style: GoogleFonts.poppins(color: Colors.black,fontWeight: FontWeight.w500,fontSize: 18),),
               ...
               Column(
                 children: [
                   Row(crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                           Image.asset("assets/images/bag.png",height: 40,),
